...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.item, null);//找到布局文件
    ...
    private void initViews(NewsData data, ViewHolder holder) {//初始化数据
         ...
         */
        holder.ivImg.setTag(data.getNewsImageUrl());//设置Tag
        ...
        getImage(this.context, data.getNewsImageUrl(), holder.ivImg);
